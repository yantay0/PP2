import pygame, sys, random, psycopg2,datetime,time
...
class MAIN:
 ...
 def check_collision(self):
  if self.fruit.pos == self.snake.body[0]:
    ...
    mixer.Sound(
        r'C:\Users\Madina\Desktop\PP2\labs\lab8\snake\resources\1_snake_game_resources_ding.mp3').play()
 ...
 def game_over(self):
   ...
   pygame.quit
   time.sleep(2)
   print(f'YOUR RESULT IS SAVED :\n{user_name} - {SCORE}\nLevel: {level}',"\n")
   sql = '''
      INSERT INTO Snake
      VALUES(%s,%s,%s,%s) RETURNING *;
    '''
   current.execute(sql,(user_name,SCORE,level,date))
   print("USER SCORE TABLE:")
   data = "select * from Snake order by  score asc"
   current.execute(data, (user_name))
...
# background music
mixer.Sound(
    r'C:\Users\Madina\Desktop\PP2\labs\lab8\snake\resources\bg_music_1.mp3').play()
...
game_over = pygame.image.load(
    r'C:\Users\Madina\Desktop\PP2\labs\lab8\snake\resources\game_over.png').convert_alpha()
